...
logistics_ondc_network_namespace = Namespace(
    "logistics_ondc_network", description="Logistics ONDC Network Namespace")
...
class OnSearchRequest(Resource):
    ...
    def post(self):
        ...
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_search", domain="logistics")
        if resp is None:
...
class OnSelectRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_select", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnInitRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_init", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnConfirmRequest(Resource):
    ...
    def post(self):
        ...
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_confirm", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnCancelRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_cancel", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnCancellationReasonsRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_cancellation_reasons", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnIssueRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_issue", domain="logistics")
        if resp is None:
...
class OnIssueStatusRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_issue_status", domain="logistics")
        if resp is None:
            dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value,
                                 action=request_payload[constant.CONTEXT]["action"])
            return send_retail_payload_to_client_logistics(request_payload,
...
class OnRatingRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_rating", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnStatusRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_status", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnSupportRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_support", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnTrackRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_track", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
...
class OnUpdateRequest(Resource):
    ...
    def post(self):
        request_payload = request.get_json()
        resp = validate_payload_schema_based_on_version(
            request_payload, "on_update", domain="logistics")
        if resp is None:
            return dump_request_payload(request_payload, domain=OndcDomain.LOGISTICS.value, action=request_payload[constant.CONTEXT]["action"])
        else:
            return resp
