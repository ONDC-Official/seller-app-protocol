...
@client_namespace.route("/v1/on_search")
...
@client_namespace.route("/v1/on_select")
...
@client_namespace.route("/v1/on_init")
...
@client_namespace.route("/v1/on_confirm")
...
@client_namespace.route("/v1/on_cancel")
...
@client_namespace.route("/v1/on_cancellation_reasons")
...
@client_namespace.route("/v1/on_issue")
...
@client_namespace.route("/v1/on_issue_status")
...
@client_namespace.route("/v1/on_rating")
...
@client_namespace.route("/v1/on_status")
...
@client_namespace.route("/v1/on_support")
...
@client_namespace.route("/v1/on_track")
...
@client_namespace.route("/v1/on_update")
